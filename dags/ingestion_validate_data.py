...
from validation_utils import calculate_criticality, compute_error_stats, split_records
...
def ingestion_validate_data():
    ...
    def validate_data(data_to_ingest: dict) -> dict:
        ...
        payload.error_criticality = calculate_criticality(payload.error_rate, payload.is_schema_valid)
